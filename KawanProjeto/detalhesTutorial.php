...
// Assim, a página de "em desenvolvimento" terá a mesma aparência do resto do site.
...
<head>
    ...
    <title>Detalhes do Tutorial - Em Desenvolvimento</title>
...
<body>
    ...
    <div class="main-content">
        <div class="message-box">
            ...
            <p>Os detalhes completos deste tutorial estão sendo cuidadosamente preparados.</p>
            <p>Agradecemos a sua paciência e volte em breve para conferir as novidades!</p>
            <a href="tutoriais.php" class="btn">Voltar para Tutoriais</a>
        </div>
    </div>
